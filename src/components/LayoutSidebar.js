...
const LayoutSidebar = ({ activePage, setActivePage }) => {
  ...
  return (
    <div className="bg-white h-full w-64 shadow-lg fixed left-0 top-0 overflow-y-auto" style={{
      background: 'linear-gradient(135deg, #e6f7ff 0%, #ffffff 100%)',
      borderRight: '1px solid rgba(0, 150, 255, 0.1)'
    }}>
      <div className="p-4 border-b border-blue-100">
        <div className="flex items-center space-x-2">
          <div className="w-10 h-10 rounded-lg overflow-hidden"> {/* Adjusted size and added overflow hidden */}
             <img 
          ...
          <h1 className="text-xl font-bold text-blue-800">Aqualiquim albercas equipo y construccion</h1>
        </div>
      </div>
