      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className={`p-4 rounded-lg text-center ${isOnline ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
              <div className="text-2xl mb-2">{isOnline ? '🌐' : '📱'}</div>
              <div className="font-semibold">{isOnline ? 'Online' : 'Offline'}</div>
            </div>
            
            <div className={`p-4 rounded-lg text-center ${isInstalled ? 'bg-purple-100 text-purple-800' : 'bg-blue-100 text-blue-800'}`}>
          ...
          {/* Feature Tests */}
          <div className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Feature Support</h2>
          ...
          <div className="space-y-6">
            <h2 className="text-2xl font-semibold text-gray-800">Interactive Tests</h2>

            {/* Cache Test */}
            <div className="bg-gray-50 p-6 rounded-lg">
              <h3 className="text-lg font-medium text-gray-800 mb-4">📦 Cache Test</h3>
              ...
              {cachedValue && (
                <div className="mt-4 p-3 bg-white rounded border">
                  ...
                  <pre className="mt-2 text-sm overflow-x-auto">{cachedValue}</pre>
                </div>
              )}
            </div>
            ...
            {/* Install Test */}
            <div className="bg-gray-50 p-6 rounded-lg">
              <h3 className="text-lg font-medium text-gray-800 mb-4">📲 Installation Test</h3>
              <div className="flex flex-col sm:flex-row gap-4">
                <button
            ...
            {/* Offline Test */}
            <div className="bg-gray-50 p-6 rounded-lg">
              <h3 className="text-lg font-medium text-gray-800 mb-4">📱 Offline Test</h3>
              <div className="flex flex-col sm:flex-row gap-4">
                <button
